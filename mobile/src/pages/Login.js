...
import { View, AsyncStorage, KeyboardAvoidingView, Platform, Image, Text, TextInput, TouchableOpacity, StyleSheet, Button } from 'react-native';
    ...
    return(
        <View style={styles.container}>
            ...
            <View style={styles.form}>
                ...
                <TouchableOpacity onPress={() => navigation.navigate('HomeAvaliado')} style={styles.button}>
